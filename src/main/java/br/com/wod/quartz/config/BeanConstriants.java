...
public class BeanConstriants {
    ...
    public static final String JOB_ENELSP_SECOND = "enelsp_second_job";
    ...
    public static final String JOB_CPFL_SECOND = "cpfl_second_job";

    //PROPERTIES
    public static final String QUARTZ_PROPERTIES = "quartz_properties";
}
